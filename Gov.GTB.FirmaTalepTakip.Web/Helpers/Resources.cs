namespace Gov.GTB.FirmaTalepTakip.Web.Helpers
{
    ...
    {
        public static string SelectInfoMsg = "Seçiniz...";
        ...
        public static string BolgeKoduSelectInfoMsg = "Bölge Kodu Seçiniz...";
        public static string KullaniciAdiParolaErrorMsg = "Kullanıcı adı veya parola hatalı!";
